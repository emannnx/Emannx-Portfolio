...
const ProfessionalSkillsSection = () => {
  return (
    <section id="professional-skills" className="py-24 md:py-32 bg-secondary/30 relative">
        ...
        >
          {professionalSkills.map((skill, index) => {
            ...
            return (
              ...
              >
                {/* Background gradient */}
                <div className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${gradientClass} opacity-0 group-hover:opacity-100 transition-opacity duration-300`} />
