...
const projects = [
  {
    ...
    description: 'A modern fintech dashboard redesign focused on simplifying complex financial data into digestible insights.',
  ...
  },
  {
    ...
    description: 'E-commerce platform redesign for a contemporary fashion brand, emphasizing minimalist aesthetics and seamless checkout.',
  ...
  },
  {
    ...
    description: 'Meditation and wellness app designed to promote mental health through calming interfaces and guided experiences.',
  ...
  },
  {
    ...
    description: 'Travel booking platform that combines beautiful destination imagery with intuitive search and booking flows.',
